...
{{-- Parece que le estamos diciendo a la plantilla "si ocurre un error con la propiedad
'title' muestrame la propiedad mensaje de ese error." --}}
...
<label class="uppercase text-gray-700 text-xs">Body</label>
